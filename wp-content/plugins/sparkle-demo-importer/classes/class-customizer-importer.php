 ...
 *
 */
if (!class_exists('Sparkle_Demo_Customizer_Importer')) {
    class Sparkle_Demo_Customizer_Importer {
        ...
        public static function import($customizerFile) {
            ...
            if ('array' != gettype($data)) {
                $error = __('Error importing settings! Please check that you uploaded a customizer export file.', 'sparkle-demo-importer');
                return;
            }
            ...
            if ($data['template'] != $template) {
                $error = __('Error importing settings! The settings you uploaded are not for the current theme.', 'sparkle-demo-importer');
                return;
            }
            ...
            if (isset($data['options'])) {
                ...
                foreach ($data['options'] as $option_key => $option_value) {
                    $option = new Sparkle_DemoImporter_Customzer_Option($wp_customize, $option_key, array(
                        'default' => '',
                        'type' => 'option',
